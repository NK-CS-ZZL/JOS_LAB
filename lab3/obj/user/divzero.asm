...
umain(int argc, char **argv)
{
  ...
  800054:	c7 04 24 88 0e 80 00 	movl   $0x800e88,(%esp)
...
libmain(int argc, char **argv)
{
  ...
  80007a:	e8 06 0b 00 00       	call   800b85 <sys_getenvid>
...
exit(void)
{
  ...
  8000c4:	e8 6a 0a 00 00       	call   800b33 <sys_env_destroy>
}
  8000c9:	c9                   	leave  
  8000ca:	c3                   	ret    
...
putch(int ch, struct printbuf *b)
{
  ...
  8000f8:	e8 f9 09 00 00       	call   800af6 <sys_cputs>
		b->idx = 0;
...
vcprintf(const char *fmt, va_list ap)
{
  ...
  800161:	e8 90 09 00 00       	call   800af6 <sys_cputs>
	 ...
	 unsigned long long num, unsigned base, int width, int padc)
{
  ...
  800268:	0f be 80 a0 0e 80 00 	movsbl 0x800ea0(%eax),%eax
...
vprintfmt(void (*putch)(int, void*), void *putdat, const char *fmt, va_list ap)
{
  ...
  800382:	ff 24 85 30 0f 80 00 	jmp    *0x800f30(,%eax,4)
  ...
  80047c:	c7 44 24 08 c1 0e 80 	movl   $0x800ec1,0x8(%esp)
  800483:	00 
  ...
  8004ae:	b8 b1 0e 80 00       	mov    $0x800eb1,%eax
...
sys_env_destroy(envid_t envid)
{
  ...
  800b60:	00 
  800b61:	c7 44 24 08 a4 10 80 	movl   $0x8010a4,0x8(%esp)
  800b68:	00 
  800b69:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  800b70:	00 
  800b71:	c7 04 24 c1 10 80 00 	movl   $0x8010c1,(%esp)
...
_panic(const char *file, int line, const char *fmt, ...)
{
  ...
  800bd0:	c7 04 24 d0 10 80 00 	movl   $0x8010d0,(%esp)
  800bd7:	e8 92 f5 ff ff       	call   80016e <cprintf>
		sys_getenvid(), binaryname, file, line);
	vcprintf(fmt, ap);
  800bdc:	89 5c 24 04          	mov    %ebx,0x4(%esp)
  800be0:	8b 45 10             	mov    0x10(%ebp),%eax
  800be3:	89 04 24             	mov    %eax,(%esp)
  800be6:	e8 22 f5 ff ff       	call   80010d <vcprintf>
	cprintf("\n");
  800beb:	c7 04 24 94 0e 80 00 	movl   $0x800e94,(%esp)
  800bf2:	e8 77 f5 ff ff       	call   80016e <cprintf>
