...
sys_env_destroy(envid_t envid)
{
  ...
  800115:	00 
  800116:	c7 44 24 08 72 0e 80 	movl   $0x800e72,0x8(%esp)
  80011d:	00 
  80011e:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  800125:	00 
  800126:	c7 04 24 8f 0e 80 00 	movl   $0x800e8f,(%esp)
...
_panic(const char *file, int line, const char *fmt, ...)
{
  ...
  800185:	c7 04 24 a0 0e 80 00 	movl   $0x800ea0,(%esp)
  ...
  80019b:	e8 51 00 00 00       	call   8001f1 <vcprintf>
	cprintf("\n");
  8001a0:	c7 04 24 c4 0e 80 00 	movl   $0x800ec4,(%esp)
