...
sys_env_destroy(envid_t envid)
{
  ...
  800123:	00 
  800124:	c7 44 24 08 90 0e 80 	movl   $0x800e90,0x8(%esp)
  80012b:	00 
  80012c:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  800133:	00 
  800134:	c7 04 24 ad 0e 80 00 	movl   $0x800ead,(%esp)
...
_panic(const char *file, int line, const char *fmt, ...)
{
  ...
  800193:	c7 04 24 bc 0e 80 00 	movl   $0x800ebc,(%esp)
  ...
  8001a9:	e8 51 00 00 00       	call   8001ff <vcprintf>
	cprintf("\n");
  8001ae:	c7 04 24 84 0e 80 00 	movl   $0x800e84,(%esp)
	 ...
	 unsigned long long num, unsigned base, int width, int padc)
{
  ...
  800358:	0f be 80 e0 0e 80 00 	movsbl 0x800ee0(%eax),%eax
...
vprintfmt(void (*putch)(int, void*), void *putdat, const char *fmt, va_list ap)
{
  ...
  800472:	ff 24 85 70 0f 80 00 	jmp    *0x800f70(,%eax,4)
  ...
  80056c:	c7 44 24 08 01 0f 80 	movl   $0x800f01,0x8(%esp)
  800573:	00 
  ...
  80059e:	b8 f1 0e 80 00       	mov    $0x800ef1,%eax
