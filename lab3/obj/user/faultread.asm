	 ...
	 unsigned long long num, unsigned base, int width, int padc)
{
  ...
  800258:	0f be 80 a0 0e 80 00 	movsbl 0x800ea0(%eax),%eax
...
vprintfmt(void (*putch)(int, void*), void *putdat, const char *fmt, va_list ap)
{
  ...
  800372:	ff 24 85 30 0f 80 00 	jmp    *0x800f30(,%eax,4)
  ...
  80046c:	c7 44 24 08 c1 0e 80 	movl   $0x800ec1,0x8(%esp)
  800473:	00 
  ...
  80049e:	b8 b1 0e 80 00       	mov    $0x800eb1,%eax
...
sys_env_destroy(envid_t envid)
{
  ...
  800b50:	00 
  800b51:	c7 44 24 08 a4 10 80 	movl   $0x8010a4,0x8(%esp)
  800b58:	00 
  800b59:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  800b60:	00 
  800b61:	c7 04 24 c1 10 80 00 	movl   $0x8010c1,(%esp)
...
_panic(const char *file, int line, const char *fmt, ...)
{
  ...
  800bc0:	c7 04 24 d0 10 80 00 	movl   $0x8010d0,(%esp)
  ...
  800bd6:	e8 20 f5 ff ff       	call   8000fb <vcprintf>
	cprintf("\n");
  800bdb:	c7 04 24 94 0e 80 00 	movl   $0x800e94,(%esp)
