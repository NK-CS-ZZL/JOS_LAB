...
sys_env_destroy(envid_t envid)
{
  ...
  80010c:	00 
  80010d:	c7 44 24 08 72 0e 80 	movl   $0x800e72,0x8(%esp)
  800114:	00 
  800115:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  80011c:	00 
  80011d:	c7 04 24 8f 0e 80 00 	movl   $0x800e8f,(%esp)
...
_panic(const char *file, int line, const char *fmt, ...)
{
  ...
  80017c:	c7 04 24 a0 0e 80 00 	movl   $0x800ea0,(%esp)
  ...
  800192:	e8 51 00 00 00       	call   8001e8 <vcprintf>
	cprintf("\n");
  800197:	c7 04 24 c4 0e 80 00 	movl   $0x800ec4,(%esp)
